...
const routes: Routes = [
...

  {
    path: 'drivers',
    loadChildren: () =>
      import('./modules/drivers/drivers.module')
...

  {
    path: 'supervisor',
    loadChildren: () =>
      import('./modules/centerSupervisor/centerSupervisor.module')
        .then(m => m.CenterSupervisorModule)
  },

  {
    path: 'centerdirector',
    loadChildren: () =>
      import('./modules/centerDirector/centerDirector.module')
        .then(m => m.CenterDirectorModule)
  },

  {
    path: 'TO',
    loadChildren: () =>
      import('./modules/TO/transport-officer.module')
        .then(m => m.TransportOfficerModule)
  },

  {
    path: 'AM',
    loadChildren: () =>
      import('./modules/AdministrationManager/AdministrationManager.module')
        .then(m => m.AdministrationManagerModule)
  },

  {
    path: 'DHRAM',
    loadChildren: () =>
      import('./modules/DHRAM/director-hr.module')
        .then(m => m.DirectorHrModule)
  },
